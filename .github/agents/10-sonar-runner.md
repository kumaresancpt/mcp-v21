...
args: {
  ...
  "content": "{\"agent\":\"10-sonar-runner\",\"phase\":\"Sonar\",\"status\":\"<success|failed|skipped>\",\"ai_calls\":0,\"input_tokens\":0,\"output_tokens\":0,\"model\":\"none\",\"mcp_calls\":<total>,\"start_time\":\"<ISO>\",\"end_time\":\"<ISO>\",\"duration_ms\":<ms>,\"notes\":\"<error or empty>\"}\n",
  "appendMode": true
}
```
