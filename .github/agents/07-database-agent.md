...
- **CRITICAL: NEVER RUN MIGRATIONS WITHOUT USER APPROVAL** — Always present schema plan in STEP 4E and wait for "Approve" response
...
## STEP 4 — Derive Entities and Write Entity Files
...
tool: write_file
args: {
  "path": ".gstack/schema-plan-approved.md",
  "content": "# Approved Database Schema Plan\n\n**Approved at:** [timestamp]\n**Approved by:** User\n**Status:** ✅ Ready for migration\n\n<Full plan details from STEP 4E including all tables, columns, relationships, indexes>\n"
}
```

This file serves as the audit trail for what was approved.

---

## STEP 5 — Update Entry Point to Register DB
...
## STEP 7 — Update Config Files with Connection String
...
## STEP 9 — Write Summary to .gstack and Output Folder
...
args: {
  ...
  "content": "{\"agent\":\"07-database-agent\",\"phase\":\"Database\",\"status\":\"<success|failed|skipped>\",\"stack\":\"<database-stack>\",\"tables_created\":<count>,\"tables_modified\":<count>,\"migration_name\":\"<name or none>\",\"user_approval\":\"✅ approved\",\"mcp_calls\":<total>,\"start_time\":\"<ISO>\",\"end_time\":\"<ISO>\",\"duration_ms\":<ms>,\"notes\":\"<error or empty>\"}\n"
}
```
