...
## USAGE LOGGING
After writing `impl-patch.md`, append one line to the usage log:
```
server: filesystem
tool: write_file
args: {
  "path": ".gstack/usage-log.jsonl",
  "content": "{\"agent\":\"08-integration-patcher\",\"phase\":\"Integration\",\"status\":\"<success|failed|skipped>\",\"files_patched\":<count>,\"endpoints_wired\":<count>,\"acs_covered\":<count>,\"mcp_calls\":<total filesystem tool calls made>,\"start_time\":\"<ISO timestamp when agent started>\",\"end_time\":\"<ISO timestamp now>\",\"duration_ms\":<elapsed ms>,\"input_tokens\":<tokens received>,\"output_tokens\":<tokens generated>,\"notes\":\"<skip reason or error, else empty>\"}\n"
}
```
